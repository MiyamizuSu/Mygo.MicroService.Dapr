...
public class ListController {
    ...
    public ListController(IMediator mediator, IIdentityService identityService, ILogger<ListController> logger) {
    ...
    [Route("create")]
    [HttpPost]
    public async Task<ActionResult<ServiceResultViewModel>> CreateAsync([FromBody] CreateListCommand command) {
